...
<section class="popular__food__area section-padding--lg bg--white">
    <div class="container">
        ...
        <div class="row mt--30">
            ...
            <?Php
                $result_count = mysqli_query($link, "SELECT COUNT(*) As total_records FROM `best_food` where idc='4';");
                ...
                $sql = "SELECT * FROM `best_food` where idc = '4' order by `best_food`.`id` desc LIMIT $offset, $total_records_per_page;";
