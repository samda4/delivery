        ...
        <div class="row">
            <div class="col-lg-12 col-md-12">
                <div class="section__title title__style--2 service__align--center section__bg__white">
                    <h2 class="title__line">Олон үндэстэний</h2>
                </div>
            </div>
        </div>
        <div class="row mt--30">
            ...
            <?Php
                $result_count = mysqli_query($link, "SELECT COUNT(*) As total_records FROM `best_food` where idc='5';");
                ...
                $sql = "SELECT * FROM `best_food` where idc = '5' order by `best_food`.`id` desc LIMIT $offset, $total_records_per_page;";
