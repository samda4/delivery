...
<div class="slider__area slider--four">
    <div class="slider__activation--1">
        <!-- Start Single Slide -->
        <div class="slide slider__fixed--height bg-image--26 poss--relative">
            <div class="container">
                <div class="row">
                        ...
                        <div class="slider__content">
                            <div class="slider__inner">
                                ...
                                <div class="slider__btn">
                                    <h2><a class="food__btn" href="#">Ресторан</a></h2>
                                </div>
        ...
        <div class="row">
            <div class="col-lg-12 col-md-12">
                <div class="section__title title__style--2 service__align--center section__bg__white">
                    <h2 class="title__line">Онцлох ресторан</h2>
            ...
            <div class="col-lg-4 col-md-6 col-sm-12 foo">
                <div class="popular__food">
                    <div class="pp_food__thumb">
                        ...
                        <div class="pp__restaurant_phone">
                    ...
                    <div class="pp__food__inner">
                        <div class="pp__food__details">
                            ...
                            <div class="pp__food__bottom d-flex justify-content-between align-items-center">
                                <div class="pp__btn">
                                    <a class="food__btn btn--transparent btn__hover--theme btn__hover--theme" href="#">Дэлгэрэнгүй</a>
                                </div>
...
<section class="fb__blog__ara pb--130 bg--white">
    <div class="container">
            ...
            <div class="col-md-12 col-lg-12">
                <div class="col-lg-12 col-md-12">
                    <div class="section__title title__style--2 service__align--center">
                        <h2 class="title__line">Сүүлд нэмэгдсэн ресторан</h2>
                        <p>Манай үйлчилгээний явц</p>
                    </div>
                </div>
            </div>
        ...
        <div class="row mt--40">
        <?php
                            $sql = "SELECT * FROM restaurant order by id desc limit 6 ; ";
                            $result = mysqli_query($link, $sql);
                            $resultCheck = mysqli_num_rows($result);
                            if ($resultCheck > 0){
                                while ($row = mysqli_fetch_assoc($result)){ ?>
            ...
            <div class="col-md-6 col-lg-4 foo col-sm-12">
                <div class="blog">
                    <div class="blog__thumb">
                        ...
                        <div class="cc__restaurant_phone">
                            <span><?php  echo $row['phone'];?></span>
                        </div>
                    </div>
