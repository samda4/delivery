...
<div class="slider__area slider--four">
    <div class="slider__activation--1">
        <!-- Start Single Slide -->
        <div class="slide slider__fixed--height bg-image--23 poss--relative">
            <div class="container">
                <div class="row">
                        ...
                        <div class="slider__content">
                            <div class="slider__inner">
                                ...
                                <div class="slider__btn">
                                    <h2><a class="food__btn" href="#">Blue Sky Restaurant</a></h2>
                                </div>
...
<section class="popular__food__area section-padding--lg bg--white">
    <div class="container">
        ...
        <div class="row mt--30">
            ...
            <?Php
                $result_count = mysqli_query($link, "SELECT COUNT(*) As total_records FROM `best_food` where r_id='23';");
